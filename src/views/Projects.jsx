  ...
  <>
    ...
    <Divider speed={0.1} offset={offset} factor={2}>
      ...
      <UpDownWide>
        ...
        <SVG icon="circle" width={16} fill={colors.pink} left="70%" top="90%" />
      ...
      <SVG icon="box" width={6} fill={colors.purple} left="10%" top="10%" />
      <SVG icon="box" width={12} fill={colors.pink} left="29%" top="26%" />
      <SVG icon="hexa" width={16} stroke={colors.teal} left="75%" top="30%" />
      <SVG icon="hexa" width={8} stroke={colors['pink-dark']} left="80%" top="70%" />
    </Divider>
  </>
)
